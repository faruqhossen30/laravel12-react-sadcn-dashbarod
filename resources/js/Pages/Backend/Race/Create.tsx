...
export default function Create({ countries, qualifiers, enums }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.races.store'));
    };

    return (
        <AdminLayout header="Create Race">
                        ...
                        <Card>
                            <CardContent className="pt-6">
                                <Button type="submit" className="w-full" disabled={processing}>
                                    {processing ? 'Creating...' : 'Create Race'}
                                </Button>
                            </CardContent>
                        </Card>
                    </div>
